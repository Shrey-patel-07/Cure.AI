...
import "./Footer.css";
import logo from "../../assets/Images/CURE_AI_footer.png";
    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="docAI_logo">
          ...
          <p className = "docAI_title">Empowering Healthcare through Artificial Intelligence</p>
        </div>
      ...
      <div className="contact">
        {/* Contact Us */}
        <p>Contact Us: Cure_AI@gmail.com</p>
